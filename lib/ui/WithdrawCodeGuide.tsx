  ...
  return (
    <div className="mb-4">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl bg-white/[0.04] border m-divider text-[12.5px] text-[#93a5ba]"
      >
          ...
          <div className="wcg-guide">
            ...
            <div className="flex items-center justify-between mt-3.5 gap-2">
              <button
                ...
                className="px-3.5 py-1.5 rounded-full text-[11px] font-bold bg-white/[0.08] border m-divider text-[#cdd8ea] disabled:opacity-30"
              >
                {t("wcg.prev")}
              </button>
