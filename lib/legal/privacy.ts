...
export const privacyContent: Record<Locale, LegalPageContent> = {
  uz: {
    ...
    intro: "Ushbu siyosat BetCore (couponbet.org) qanday ma'lumot to'plashi, ishlatishi va himoya qilishini tushuntiradi.",
    sections: [
  ...
  ru: {
    ...
    intro: "Эта политика объясняет, какие данные собирает, использует и защищает BetCore (couponbet.org).",
    sections: [
  ...
  en: {
    ...
    intro: "This policy explains what data BetCore (couponbet.org) collects, uses, and protects.",
    sections: [
