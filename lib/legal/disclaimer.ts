...
export const disclaimerContent: Record<Locale, LegalPageContent> = {
  uz: {
    ...
    intro: "Ushbu sahifa BetCore'ning hamkorlik (affiliate) modeli va mazmuni bo'yicha ogohlantirishlarni o'z ichiga oladi.",
    sections: [
      { heading: "Affiliate hamkorlik", body: "BetCore ba'zi litsenziyalangan bahs kompaniyalari bilan affiliate (hamkorlik) shartnomasiga ega. Agar siz sayt orqali hamkor kompaniyaga o'tsangiz va ro'yxatdan o'tsangiz, BetCore komissiya olishi mumkin. Bu sizning xarajatlaringizga ta'sir qilmaydi." },
  ...
  ru: {
    ...
    intro: "Эта страница содержит важные уведомления о партнёрской (affiliate) модели и содержании BetCore.",
    sections: [
      { heading: "Партнёрское сотрудничество", body: "BetCore имеет партнёрские (affiliate) соглашения с некоторыми лицензированными букмекерскими компаниями. Если вы переходите к партнёру через наш сайт и регистрируетесь, BetCore может получить комиссию. Это не влияет на ваши расходы." },
  ...
  en: {
    ...
    intro: "This page contains important notices about BetCore's affiliate model and content.",
    sections: [
      { heading: "Affiliate partnerships", body: "BetCore has affiliate agreements with some licensed betting companies. If you follow a link to a partner through our site and register, BetCore may earn a commission. This does not affect your costs." },
