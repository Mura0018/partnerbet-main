...
export const termsContent: Record<Locale, LegalPageContent> = {
  uz: {
    ...
    intro: "Ushbu shartlar PartnerBet (couponbet.org) saytidan foydalanishni tartibga soladi. Saytdan foydalanish orqali siz ushbu shartlarga rozilik bildirasiz.",
    sections: [
      { heading: "1. Xizmat tavsifi", body: "PartnerBet — futbol yangiliklari, tahlillari va litsenziyalangan hamkorlar haqidagi ma'lumotni taqdim etuvchi mustaqil media/affiliate platforma. Biz o'zimiz bahs qabul qilmaymiz." },
      ...
      { heading: "4. Hamkor havolalari", body: "Sayt hamkor kompaniyalarga yo'naltiruvchi havolalarni o'z ichiga oladi. Bu havolalar orqali o'tganingizda, siz o'sha kompaniyaning shartlariga bo'ysunasiz — PartnerBet ularning xizmatlari uchun javobgar emas." },
      { heading: "5. Intellektual mulk", body: "Saytdagi barcha kontent (matn, dizayn, logotip) PartnerBet yoki tegishli litsenziya beruvchilarga tegishli. Ruxsatsiz nusxalash yoki tijorat maqsadida ishlatish taqiqlanadi." },
  ...
  ru: {
    ...
    intro: "Эти условия регулируют использование сайта PartnerBet (couponbet.org). Используя сайт, вы соглашаетесь с данными условиями.",
    sections: [
      { heading: "1. Описание услуги", body: "PartnerBet — независимая медиа-/партнёрская платформа, предоставляющая футбольные новости, аналитику и информацию о лицензированных партнёрах. Мы сами не принимаем ставки." },
      ...
      { heading: "4. Партнёрские ссылки", body: "Сайт содержит ссылки на партнёрские компании. Переходя по ним, вы принимаете условия соответствующей компании — PartnerBet не несёт ответственности за их услуги." },
      { heading: "5. Интеллектуальная собственность", body: "Весь контент сайта (текст, дизайн, логотип) принадлежит PartnerBet или соответствующим лицензиарам. Копирование или коммерческое использование без разрешения запрещено." },
  ...
  en: {
    ...
    intro: "These terms govern your use of the PartnerBet (couponbet.org) website. By using the site, you agree to these terms.",
    sections: [
      { heading: "1. Description of service", body: "PartnerBet is an independent media/affiliate platform providing football news, analysis, and information about licensed partners. We do not ourselves accept wagers." },
      ...
      { heading: "4. Partner links", body: "The site contains links to partner companies. By following these links you become subject to that company's own terms — PartnerBet is not responsible for their services." },
      { heading: "5. Intellectual property", body: "All content on the site (text, design, logo) belongs to PartnerBet or its licensors. Unauthorized copying or commercial use is prohibited." },
