...
export const responsibleGamingContent: Record<Locale, LegalPageContent> = {
  uz: {
    ...
    intro: "BetCore mas'uliyatli o'yin g'oyasini qo'llab-quvvatlaydi. Bahs — bu ko'ngilochar mashg'ulot bo'lishi kerak, moliyaviy muammolarni hal qilish vositasi emas.",
    sections: [
      ...
      { heading: "Bizning rolimiz", body: "BetCore o'zi bahs qabul qilmaydi — biz faqat ma'lumot beruvchi platformamiz. Litsenziyalangan operatorlar mas'uliyatli o'yin vositalarini taqdim etish uchun javobgar." },
    ],
  },
  ru: {
    title: "Ответственная игра",
    intro: "BetCore поддерживает принципы ответственной игры. Ставки должны быть развлечением, а не способом решения финансовых проблем.",
    sections: [
      ...
      { heading: "Наша роль", body: "BetCore сам не принимает ставки — мы только информационная платформа. За предоставление инструментов ответственной игры отвечают лицензированные операторы." },
    ],
  },
  en: {
    title: "Responsible Gaming",
    intro: "BetCore supports the principles of responsible gaming. Betting should be entertainment, not a way to solve financial problems.",
    sections: [
      ...
      { heading: "Our role", body: "BetCore does not itself accept wagers — we are an information platform only. Licensed operators are responsible for providing responsible gaming tools." },
    ],
  },
};
