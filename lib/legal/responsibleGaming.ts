...
export const responsibleGamingContent: Record<Locale, LegalPageContent> = {
  uz: {
    ...
    intro: "PartnerBet mas'uliyatli o'yin g'oyasini qo'llab-quvvatlaydi. Bahs — bu ko'ngilochar mashg'ulot bo'lishi kerak, moliyaviy muammolarni hal qilish vositasi emas.",
    sections: [
      ...
      { heading: "Bizning rolimiz", body: "PartnerBet o'zi bahs qabul qilmaydi — biz faqat ma'lumot beruvchi platformamiz. Litsenziyalangan operatorlar mas'uliyatli o'yin vositalarini taqdim etish uchun javobgar." },
    ],
  },
  ru: {
    title: "Ответственная игра",
    intro: "PartnerBet поддерживает принципы ответственной игры. Ставки должны быть развлечением, а не способом решения финансовых проблем.",
    sections: [
      ...
      { heading: "Наша роль", body: "PartnerBet сам не принимает ставки — мы только информационная платформа. За предоставление инструментов ответственной игры отвечают лицензированные операторы." },
    ],
  },
  en: {
    title: "Responsible Gaming",
    intro: "PartnerBet supports the principles of responsible gaming. Betting should be entertainment, not a way to solve financial problems.",
    sections: [
      ...
      { heading: "Our role", body: "PartnerBet does not itself accept wagers — we are an information platform only. Licensed operators are responsible for providing responsible gaming tools." },
    ],
  },
};
