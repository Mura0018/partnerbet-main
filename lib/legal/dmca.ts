...
export const dmcaContent: Record<Locale, LegalPageContent> = {
  uz: {
    title: "DMCA siyosati",
    intro: "BetCore mualliflik huquqlarini hurmat qiladi va qonuniy DMCA (yoki tegishli mahalliy qonun) da'volariga javob beradi.",
    sections: [
  ...
  ru: {
    title: "Политика DMCA",
    intro: "BetCore уважает авторские права и реагирует на законные претензии DMCA (или соответствующего местного законодательства).",
    sections: [
  ...
  en: {
    title: "DMCA Policy",
    intro: "BetCore respects copyright and responds to legitimate DMCA (or applicable local law) claims.",
    sections: [
