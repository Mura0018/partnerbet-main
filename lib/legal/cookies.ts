...
export const cookiesContent: Record<Locale, LegalPageContent> = {
  uz: {
    ...
    intro: "Ushbu sahifa PartnerBet qanday cookie fayllardan foydalanishini tushuntiradi.",
    sections: [
      ...
      { heading: "Uchinchi tomon cookie'lari", body: "Hamkor kompaniya saytiga o'tganingizda, o'sha sayt o'z cookie siyosatiga ega bo'lishi mumkin — bu PartnerBet nazoratidan tashqarida." },
  ...
  ru: {
    ...
    intro: "Эта страница объясняет, как PartnerBet использует файлы cookie.",
    sections: [
      ...
      { heading: "Cookie третьих сторон", body: "При переходе на сайт партнёрской компании у неё может быть собственная политика cookie — это вне контроля PartnerBet." },
  ...
  en: {
    title: "Cookie Policy",
    intro: "This page explains how PartnerBet uses cookies.",
    sections: [
      ...
      { heading: "Third-party cookies", body: "When you visit a partner company's site, that site may have its own cookie policy — this is outside PartnerBet's control." },
